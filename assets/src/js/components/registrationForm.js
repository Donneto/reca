...
// firebase.initializeApp(config.get('app.fb'));
            ...
            <form onSubmit={(e) => this._handleFormSubmit(e)}>
                ...
                <div className="field-body">
                  <div className="field">
                    <div className="control has-icons-left">
                      <input className="input is-primary" type="text" name="nombre" placeholder="ejem.: Importadora de Lacteos El torito" required="required" onChange={e => this._handleInputChange(e) }/>
                  ...
                  <div className="field is-expanded">
                    <div className="field has-addons">
                      <div className="control has-icons-left is-expanded">
                        <input className="input is-primary" type="text" name="email" placeholder="tuemail@tu.com" required="required" onChange={e => this._handleInputChange(e) } />
                        <span className="icon is-left">
              ...
              <div className="field is-horizontal">
                ...
                <div className="field-body">
                  <div className="field">
                    <div className="control has-icons-left">
                      <input className="input is-primary" type="text" name="telefono" placeholder="1234-5678 &oacute; 1234-5678/0987-6543 &oacute; *2222 " required="required" onChange={e => this._handleInputChange(e) }/>
                      <span className="icon is-left">
              ...
              <div className="field is-horizontal">
                ...
                <div className="field-body">
                  <div className="field">
                    <div className="control has-icons-left">
                      <input className="input is-primary" type="text" name="whatsapp" placeholder="1234-5678 &oacute; 1234-5678/0987-6543" onChange={e => this._handleInputChange(e) }/>
                      <span className="icon is-left">
              ...
              <div className="field is-horizontal">
                ...
                <div className="field-body">
                  <div className="field">
                    <div className="control has-icons-left">
                      <input className="input is-primary" type="text" name="direccion" placeholder="ejem.: Col. Alameda, Casa #x Calle 56" required="required" onChange={e => this._handleInputChange(e) }/>
                      <span className="icon is-left">
              ...
              <div className="field is-horizontal">
                ...
                <div className="field-body">
                  <div className="field">
                    <div className="control">
                      <textarea className="textarea is-primary" name="direccionb" placeholder="Agrega mas detalle sobre tu direcci&oacute;n para facilitarle a los dem&aacute;s poder encontrarte" onChange={e => this._handleInputChange(e) }/>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="field is-horizontal">
                ...
                <div className="field-body">
                  <div className="field is-narrow">
                    ...
                    <div className="control">
                      <div className="select is-fullwidth is-small is-primary">
              ...
              <div className="field is-horizontal">
                <div className="field-label is-normal">
                  <label className="label"><sup>*</sup>Productos Principales:</label>
                </div>
                <div className="field-body">
                  <div className="field is-expanded">
                    <div className="field has-addons">
                      <div className="control has-icons-left is-expanded">
                        <input className="input is-primary" name="productos" type="text" placeholder="ejem.: maiz, frescos, coca cola, frijoles" required="required" onChange={e => this._handleInputChange(e) }/>
                        <span className="icon is-left">
              ...
              <div className="field is-horizontal">
                ...
                <div className="field-body">
                  <div className="field is-expanded">
                    <div className="field has-addons">
                      <div className="control has-icons-left is-expanded">
                        <input className="input is-primary" readOnly type="text" value={internals.uniqueKey} />
                        <span className="icon is-left">
              ...
              <div className="has-text-centered">
                ...
                <button className="button is-primary is-medium"><b>¡Registrame!</b></button>
              </div>
            </form>
          </div>
        </div>
